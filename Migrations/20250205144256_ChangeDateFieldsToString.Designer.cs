...
namespace WPR_backend.Migrations
{
    ...
    [Migration("20250205144256_ChangeDateFieldsToString")]
    partial class ChangeDateFieldsToString
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Verhuur", b =>
                {
                    ...
                    b.Property<string>("Inleverlocatie")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("Ophaallocatie")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WPR_backend.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WPR_backend.Models.User", null)
                        .WithMany()
